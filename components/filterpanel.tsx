...
export default function FilterSidebar({
    ...
    return (
        <aside className="bg-[#181818] rounded-lg p-6 space-y-7 w-full lg:w-80 shrink-0 h-fit">
            <div className="flex items-center justify-between">
                <h2 className="text-lg font-bold">
                    Filters {activeCount > 0 && <span className="text-xs font-normal text-[#B3B3B3]">({activeCount})</span>}
                </h2>
            ...
            <button
                ...
                onClick={apply}
                disabled={isPending}
                className="w-full bg-gradient-to-br from-indigo-500 via-violet-400 to-teal-100 text-white py-2.5 rounded-full text-sm font-medium hover:scale-[1.02] transition-transform disabled:opacity-50"
            >
